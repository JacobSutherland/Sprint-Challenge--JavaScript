...
*/
const populationTotal = zooAnimals.reduce((sum ,i) => sum + i.population, 0);
// populationTotal = zooAnimals.reduce((a,b) => a.population + b.population, 0);
